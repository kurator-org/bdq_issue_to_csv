...
if [ $ok = "true" ]; then
	...
	java -jar ./target/issueconverter-1.0.0-jar-with-dependencies.jar -f issuelist.json -u ../bdq/tg2/core/usecase_test_list.csv -l ../bdq/tg2/core/test_label_mappings.csv -g ../bdq/tg2/core/TG2_tests_additional_guids.csv -a ../bdq/tg2/core/TG2_tests_argument_guids.csv
	cd ../
